...
public class Controller {
	 ...
	 */
	public RecentPurchaseInformation processItem(IdentificationNumber itemID, int quantity) throws InvalidItemIDException {
		ItemDescription itemDescription = inventorySystem.retrieveItemDescription(itemID);
